<template>
  <div>
    <div class="div1">
      <van-search placeholder="搜索" shape="round" ></van-search>
    </div>
    <div class="divx"></div>
    <div class="div2">
      <van-tree-select :items="items" :active-id.sync="activeId" :main-active-index.sync="activeIDX"
      height="100%"
      >
        <template slot="content">
          <div v-if="activeIDX==0" style="position:fixed">
