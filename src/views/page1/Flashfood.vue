<template>
  <div id="falshFood">
    <div class="flashItemwrapper">
      <ul class="ulWrapper">
        <li class="itemInCovers" v-for="(item,index) in pro_list" :key="index">
          <img  class="itemImage"  :src="`http://127.0.0.1:4000/pro/`+item.img_url" alt="">
...
<style scoped>
  ...
  .title {
    ...
    display: -webkit-box;
    overflow: hidden;
    text-overflow: ellipsis; /*文字只显示在一行*/
    padding-left:1rem;
  }
  .price{
    display: inline-block;
